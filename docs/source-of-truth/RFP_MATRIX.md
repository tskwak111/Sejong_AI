...
| SFR-002 | 민원 의도 분류 | 전입·주민등록, 증명서, 대형폐기물, 지방세, 범위 밖과 topic/coverage를 closed enum으로 분류 | P0 실제 구현 + selectable classifier; A-076 actual FAIL at transport | frozen classifier 60/60, Hybrid UAT route/intent/topic 48/48, A-076 offline/readiness/network probe PASS, actual 20/0·11/9·outbound9 but transport-no-response9, retention/retry/rerun0 | 모호 질문은 exact FOLLOWUP, topic 없음은 INSUFFICIENT_GROUNDING. local/private selector만 허용하고 final answer 생성은 Upstage 유지. 3초 timeout 만료가 가장 강한 가설이며 DeepSeek 실제 classifier 성공은 미검증 |
