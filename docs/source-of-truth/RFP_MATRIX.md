...
| SFR-002 | 민원 의도 분류 | 전입·주민등록, 증명서, 대형폐기물, 지방세, 범위 밖과 topic/coverage를 closed enum으로 분류 | P0 실제 구현 + selectable classifier; A-079 transport/wire verified, quality FAIL 6/9; A-080 provider-free rubric implementation Offline Review | frozen classifier 60/60, Hybrid UAT 48/48; A-079 provider response/2xx/strict/accepted9/9/9/9, oracle6/9; A-080 prompt22·framing1·shared-provider133·controlled-wrapper9 PASS | 모호 질문은 exact FOLLOWUP, topic 없음은 INSUFFICIENT_GROUNDING. A-080 root/offline/readiness/actual은 0이고 DeepSeek local/private 연결·wire 성공은 quality PASS나 default 승격을 뜻하지 않는다. final answer 생성은 Upstage 유지 |
