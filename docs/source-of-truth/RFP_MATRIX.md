...
| SFR-002 | 민원 의도 분류 | 전입·주민등록, 증명서, 대형폐기물, 지방세, 범위 밖과 topic/coverage를 closed enum으로 분류 | P0 실제 구현 + selectable classifier; A-079 transport/wire verified, quality FAIL | frozen classifier 60/60, Hybrid UAT 48/48; A-079 provider response/2xx/strict/accepted9/9/9/9, oracle6/9 | 모호 질문은 exact FOLLOWUP, topic 없음은 INSUFFICIENT_GROUNDING. DeepSeek local/private 연결과 wire는 성공했지만 fixed oracle 3건 불일치로 default 승격하지 않는다. final answer 생성은 Upstage 유지 |
