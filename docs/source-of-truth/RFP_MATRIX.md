...
| SFR-002 | 민원 의도 분류 | 전입·주민등록, 증명서, 대형폐기물, 지방세, 범위 밖과 topic/coverage를 closed enum으로 분류 | P0 실제 구현 + A-074 selectable classifier Tasks 1~6b offline READY / actual pending | frozen classifier 60/60, Hybrid UAT route/intent/topic 48/48, A-074 final review C0/I0/M0와 area 656+5 PASS, DeepSeek fixed20 one-shot pending | 모호 질문은 exact FOLLOWUP, topic 없음은 INSUFFICIENT_GROUNDING. local/private selector만 허용하고 final answer 생성은 Upstage 유지 |
