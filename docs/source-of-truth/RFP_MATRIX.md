...
| SFR-002 | 민원 의도 분류 | 전입·주민등록, 증명서, 대형폐기물, 지방세, 범위 밖과 topic/coverage를 closed enum으로 분류 | P0 실제 구현 + selectable classifier; A-080 transport/wire verified, strict quality FAIL 8/9 | frozen classifier 60/60, Hybrid UAT 48/48; A-080 response/2xx/strict/accepted9/9/9/9, oracle8/9; prompt22·framing1·shared-provider133·controlled-wrapper9 PASS | 모호 질문은 exact FOLLOWUP, topic 없음은 INSUFFICIENT_GROUNDING. A-080은 exact-one 소비·재실행 금지이며 local/private wire 성공과 8/9는 quality PASS나 default 승격을 뜻하지 않는다. 시민 runtime은 deterministic fallback, final answer 생성은 Upstage 유지 |
