...
| A-044 | A / Blocker | LLM 공급자 전환·실사용 경계 | Resolved — actual FAIL / option B not approved | Q-LLM-005=A local/private actual 완료: Upstage exact `solar-pro3`, outbound 30, strict-schema 27/30, 인간 검토 9개 평균 4.8444·최저 4, VAT 포함 USD 0.004654815. JSON 100% criterion 미충족 | D-065~D-067/D-071/ADR-0022/LLM-002 report. provider disabled/template 유지; 시민/free-input/public/remote 사용 금지. 향후 튜닝은 새 승인·버전·평가 필요 |
