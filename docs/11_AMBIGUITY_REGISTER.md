...
| A-080 | B / High | A-079 oracle 6/9의 provider-neutral 품질 교정 방향 | Resolved for specification / execution plan Review | Q-LLM-016-QUALITY=A/D-133은 shared prompt에 다섯 route 의미·narrowest-row·binding exclusions를 추가하는 compact rubric을 선택했고 D-134가 written specification을 승인했다. 사용자의 literal Q-LLM-015 답변은 기존 D-128 ID와 충돌해 canonical alias로 분리했다. Product code/provider call은 아직 0이며 plan approval과 별도 actual approval gate를 유지한다. | D-133/D-134, ADR-0028 fifth amendment, A-080 specification/plan, IMP-011/012 |
