...
| A-061 | A / Blocker | “현실에서 사용 가능한 민원처리”의 목표 경계 | Pending Q-PROD-REAL-001 | 현재 제품은 공식 KB 기반 정보 안내·운영 개선 플랫폼이며 실제 신청·상태조회·결제·기관 시스템 연계는 P2다. 현실형 안내·운영센터를 고도화할지 실제 처리 플랫폼으로 범위를 바꿀지에 따라 인증·법무·API·DB·배포가 달라진다. | 추천/기본값 A: 안내·운영 플랫폼을 먼저 production-ready 수준으로 고도화하고 실제 신청·조회는 별도 기관 연계 사업으로 유지 |
