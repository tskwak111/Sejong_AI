...
| A-080 | B / High | A-079 oracle 6/9의 provider-neutral 품질 교정 방향 | Resolved for design / written spec Review | Q-LLM-016-QUALITY=A/D-133은 shared prompt에 다섯 route 의미·narrowest-row·binding exclusions를 추가하는 compact rubric을 선택했다. 사용자의 literal Q-LLM-015 답변은 기존 D-128 ID와 충돌해 canonical alias로 분리했다. Product code와 provider actual은 아직 0이며 spec/plan/actual은 각 gate를 유지한다. | D-133, ADR-0028 fourth amendment, A-080 specification, IMP-011 |
