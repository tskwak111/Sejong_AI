...
| A-076 | A / Blocker | A-075 transport FAIL 뒤 네트워크 복구 확인과 별도 actual 권한 | Resolved / execution authorized | DNS·TCP443·TLS/HTTP value-free probe가 PASS했고 사용자가 재실행을 승인했다. A-075는 immutable로 보존하고 A-076 identity에서 offline/readiness 뒤 동일 synthetic actual을 정확히 한 번만 실행한다. | D-126, ADR-0028, A-076 specification/plan, IMP-008 |
