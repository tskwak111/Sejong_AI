...
| A-077 | A / Blocker | A-076 3초 전체 timeout 가설의 최소 교정과 추가 actual 권한 | Resolved / implementation in progress | Q-LLM-015=A/D-128로 connect/write/pool3초·read/complete10초·retry0을 확정했다. 새 A-077 identity에서 offline/readiness→1-call 2xx probe→조건부 9-call actual 순서만 허용하며 이전 증거를 불변 보존한다. | D-128, ADR-0028 amendment, A-077 specification/plan, IMP-009 |
