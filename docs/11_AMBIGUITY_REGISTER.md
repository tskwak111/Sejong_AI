...
| A-073 | B / High | exact five-key 응답 9건이 enum/shape 검증에서 모두 거절된 원인과 다음 bounded 교정 | Implemented offline / actual exact-one approval pending | D-120 승인으로 shared builder·five refined stages·explicit route matrix·literal `NONE`·intent-grouped catalog·wire oracle를 TDD 구현했다. area 386·controlled-double 39·Ruff/Mypy 115가 PASS했고 provider/network actual call·cost는 0이다. baseline-stale mock JSON null 1건은 RED 뒤 exact wire `"NONE"`으로만 교정했다. 기존 body·질문·wrong value·fixture별 stage 비보관과 fail-closed를 유지한다. Task 5 root/clean-source gate와 actual은 분리되며, actual은 exact 별도 인간 승인 뒤에만 가능하다. | D-117~D-120, ADR-0027, A-073 approved specification/plan, IMP-20260729-003/004/005 |
