...
| A-072 | B / High | provider가 exact five-key closed object를 반환하도록 만드는 다음 단일 교정 | In Progress — Tasks 1~4 offline GREEN; actual Pending | D-116으로 plan과 Subagent-Driven 구현을 승인했다. provider-only exact `NONE` parser, bounded canonical prompt, fresh strict schema를 구현하고 area 333·controlled-double 24·Ruff/Mypy 115 PASS, provider call/cost 0을 확인했다. Task 5 root/clean-source gate 뒤에도 Task 6 actual은 D-117 exact 인간 승인 전 금지한다. | D-111~D-116, ADR-0027, A-072 spec/plan, IMP-20260728-012~017 |
