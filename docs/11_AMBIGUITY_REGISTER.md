...
| A-075 | A / Blocker | A-074 immutable FAIL 뒤 별도 DeepSeek corrective actual 권한과 identity | Resolved / execution authorized | 사용자가 A-075 actual 1회를 명시 승인했다. A-074 증거와 runner invocation은 불변으로 두고 `67fe37c...` 기반 별도 branch에서 A-075 전용 offline/actual path·gate·lease를 사용한다. offline PASS와 clean source/readiness 전 outbound 0이며 실제 실행 뒤 결과와 무관하게 rerun0이다. | D-124, ADR-0028, A-075 discovery/spec/plan |
