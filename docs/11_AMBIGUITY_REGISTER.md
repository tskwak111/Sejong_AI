...
| A-060 | A / Blocker | hybrid 분류와 grounded generation의 provider 호출·비용 상한 | Resolved / implemented offline | historical actual 20/30/40·USD0.05는 보존하고 local interactive demo는 80/100/160·USD0.20 pre-reservation stop, retry 0, concurrency 1로 구현했다. | D-087/D-095 historical; D-099/D-102~D-104; actual 20-case gate pending |
...
| A-067 | A / Blocker | 긴 local UAT에서 lifetime provider cap 소진 | Resolved / implemented offline | local interactive demo는 classifier 80/generator 100/combined 160, VAT 포함 USD0.20 pre-reservation stop. cap 실패는 무저장 분야 선택 FOLLOWUP이며 production rate limit은 별도다. | D-099/D-102~D-104; metering tests PASS, actual Task 10 pending |
