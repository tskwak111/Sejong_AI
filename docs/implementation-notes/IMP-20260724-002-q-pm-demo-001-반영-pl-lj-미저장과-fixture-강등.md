...
- [x] 질문 원문 URL 전달 제거 (`/chat?q=`·useSearchParams 폐지, 상태 전달) — IMP-20260724-001에서 선반영, 본 세션에서 유지 확인
