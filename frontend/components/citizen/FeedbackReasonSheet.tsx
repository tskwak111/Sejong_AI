 ...
 * 미선택 형제 opacity 0.45.
 *
 * [임시값 근거] 2026-07-22, 무인 세션 결정사항: 사유 코드 목록은 백엔드
 * 미확정(CLAUDE.md §11)이라 아래 4종을 임시 정의. 확정 시 이 목록만 교체.
 */
...
export default function FeedbackReasonSheet({
  ...
  onSubmit: (category: CivilCategory, reasonCode: string) => void;
}) {
  const [category, setCategory] = useState<CivilCategory | null>(null);
