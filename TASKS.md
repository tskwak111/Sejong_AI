...
| LLM-003 | P1 | Architecture·AI/Data·Backend·Frontend·Security | [local/private 근거 제한형 Upstage 시민 답변 생성](docs/superpowers/specs/2026-07-25-grounded-live-chat-generation-design.md) | Review — design approved / written specification review | D-072/ADR-0023, LLM-002 actual FAIL, API-CHAT-001, WEB-CHAT-001 | supported+masked+ACTIVE/OFFICIAL+grounded만 8초·1 attempt 호출, server-issued fact ID·server-bound source, 모든 오류 전체 template fallback, `answer_mode` 계약/Web 배지, provider-disabled 전체 회귀. written spec·계획 승인 전 코드/계약/actual call 0; public/remote 금지 |
