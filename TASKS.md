...
| WEB-DEV-ORIGIN-001 | P1 | Frontend·Platform | Next.js local 개발 origin 명시 | Review — owner branch implementation | PR #8/#9 integration, D-070, [approved design](docs/superpowers/specs/2026-07-24-post-mvp-main-stabilization-design.md) | `allowedDevOrigins: ["127.0.0.1"]` exact 설정과 config 회귀·Web gate를 owner branch에서 검증한다. 팀원 PR #10은 owner-reviewed scope라 자동 병합하지 않으며 public CORS·배포 승인으로 해석하지 않는다 |
