...
| LLM-003 | P1 | Architecture·AI/Data·Backend·Frontend·Security | [local/private 근거 제한형 Upstage 시민 답변 생성](docs/superpowers/specs/2026-07-25-grounded-live-chat-generation-design.md) / [TDD 실행계획](docs/superpowers/plans/2026-07-25-grounded-live-chat-generation.md) / [offline evidence](docs/test-reports/LLM-003-GROUNDED-LIVE-CHAT.md) / [implementation note](docs/implementation-notes/IMP-20260725-005-llm-003-grounded-live-chat-implementation.md) | Review — offline implementation and final repository gate complete; actual network Pending human gate | D-072~D-074/ADR-0023, LLM-002 actual FAIL, API-CHAT-001, WEB-CHAT-001 | supported+masked+ACTIVE/OFFICIAL+grounded만 8초·1 attempt 호출, server-issued fact ID·server-bound source, 모든 오류 전체 template fallback, `answer_mode` 계약/Web 배지, provider-disabled root gate 및 390/430/desktop E2E PASS. actual network·public/remote·자동 merge 금지 |
