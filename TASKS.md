...
| MVP-001 | P0 | 전체 | [7/25 local/private 핵심 개선 루프](docs/superpowers/specs/2026-07-22-four-day-local-private-core-loop-mvp-design.md) | Review — local/private AI scope and actual Web evidence complete; Draft PR #9 open | Q-MVP-001=A/D-058/ADR-0020, Q-PM-DEMO-001=B/D-068, [approved plan](docs/superpowers/plans/2026-07-22-four-day-local-private-core-loop-mvp.md), [sample report](docs/test-reports/MVP-001-SAMPLE-20-RESULT.md), [Draft PR #9](https://github.com/tskwak111/Sejong_AI/pull/9) | actual PERSONAL interaction-event/failed-row delta 0/0, 별도 INSUFFICIENT_GROUNDING delta 1/1, same-writer block, PM approval, final ACTIVE 20·target 1·requery source `KB-WASTE-03`·ready200와 current PR #8 UI actual desktop browser 1/1 PASS. 승인 checklist 3/3과 feedback dialog keyboard gate도 통과했다. sample 20/20와 API/contracts/DB closeout 유지. Draft PR #9 사람 검토·수동 병합은 Pending; public admin auth/remote/provider-ready 아님 |
...
| WEB-DEV-ORIGIN-001 | P1 | Frontend·Platform | Next.js local 개발 origin 명시 | Pending — 별도 Frontend PR | PR #8 owner integration, 사용자 2026-07-24 지시 | `allowedDevOrigins: ["127.0.0.1"]`만 별도 frontend/config PR에서 적용·Web gate 통과·owner review. 현재 owner Draft PR에는 섞지 않으며 public CORS·배포 승인으로 해석하지 않는다 |
