...
| LLM-003 | P1 | Architecture·AI/Data·Backend·Frontend·Security | [local/private 근거 제한형 Upstage 시민 답변 생성](docs/superpowers/specs/2026-07-25-grounded-live-chat-generation-design.md) / [TDD 실행계획](docs/superpowers/plans/2026-07-25-grounded-live-chat-generation.md) / [local/private evidence](docs/test-reports/LLM-003-GROUNDED-LIVE-CHAT.md) / [implementation note](docs/implementation-notes/IMP-20260726-002-llm-003-local-actual-실행과-aggregate-증거.md) | Done — approved local/private actual PASS; public/remote prohibited | D-072~D-075/ADR-0023, LLM-002 actual FAIL, API-CHAT-001, WEB-CHAT-001 | supported+masked+ACTIVE/OFFICIAL+grounded만 8초·1 attempt 호출, server-issued fact ID·server-bound source, 모든 오류 전체 template fallback. actual PII-free fixture 10건 GENERATED 4/TEMPLATE 6·출처 10/10·공식 mismatch 0·typed write-boundary 위반 0·outbound 10. legacy reported cost lower-bound USD 0.001319835, configured upper USD 0.0135168<0.05; public/remote·자동 merge 금지 |
