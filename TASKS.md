...
| OFFICE-API-001 | P1 | Backend·Contract·QA | declared `GET /api/v1/offices`와 FastAPI runtime 정합 / [실행계획](docs/superpowers/plans/2026-07-26-office-api-runtime-parity.md) / [구현 노트](docs/implementation-notes/IMP-20260726-012-office-api-runtime-parity.md) | Done — Draft PR pending human merge | CONTRACT-001, DB-001, Q-API-OFFICES-001=A/D-078/D-079 | default route discovery와 local injected OFFICIAL-only `public_id` order, match/valid-empty 200, value-free 422, safe 503를 구현했다. constituent API 2,043 PASS·shared 90/90·docs/secret/diff PASS; actual Docker/Supabase smoke는 local prerequisite 부재로 Pending. DB/data/Web/LLM/dependency/public/remote 변경 0 |
