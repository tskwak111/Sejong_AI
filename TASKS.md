...
| LLM-002 | P1 | AI/Data·Backend·Security·PM | [Upstage Solar Pro 3 합성 평가와 장애 fallback](docs/superpowers/specs/2026-07-23-upstage-solar-pro3-synthetic-evaluation-design.md) / [승인 실행계획](docs/superpowers/plans/2026-07-23-upstage-solar-pro3-synthetic-evaluation.md) | In Progress — Task 1 complete/review clean | AI-001, Q-LLM-005=A/D-065~D-067/ADR-0022 | exact fail-closed settings와 disabled example, malformed/non-string rejection, focused 6/Ruff/Mypy, independent review clean. key/network/public chat/DB/data/dependency 0; 다음 Task 2 strict JSON/prompt/cost, 실제 시민 연결은 별도 B 승인 |
